...
![Agent 工作原理示意](./images/6/ch6_1.png)
...
![Dify 两种工作流类型示意](./images/6/ch6_2.png)
...
*参考文档：*
- *[跨境电商答疑助手完整对话流](./doc/6/跨境电商答疑助手完整对话流.md)*
- *[NLP2SQL数据库查询工作流](./doc/6/NLP2SQL数据库查询工作流.md)*
- *[MySQL数据库操作教程](./doc/6/MySQL数据库操作教程.md)*
