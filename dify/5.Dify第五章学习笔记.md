...
![Function Calling 工作原理](./images/ch5_1.png)
...
![有无 Function Call 流程对比](./images/ch5_2.png)
...
*参考文档：[自定义天气查询插件完整教程.md](./doc/自定义天气查询插件完整教程.md)*  
*插件源码：[main.py](./doc/main.py)*  
